...
var (
	...
	GenesisSignatureStr = "66e96efad0b3afb5fcedc22824813c86f892ea408029e52f455cc39c55dc68f0564d608bc55a081820115ac1d1aedd7923c375502e0f24a76bcffd06e1bc50fc01"
	// GenesisAddressStr genesis address string
	GenesisAddressStr = "oAsQrHGUVUnHCHL8HC5u9Vfdy4nUVmTEBP"
	// BlockchainPubkeyStr pubic key string
	BlockchainPubkeyStr = "023bde0a9b5036a21373571a40b1624ab86eb089242027accfa9434858338c2b21"
	// BlockchainSeckeyStr empty private key string
	BlockchainSeckeyStr = ""

	// GenesisTimestamp genesis block create unix time
	GenesisTimestamp uint64 = 1531474556
...
func (c *Config) register() {
	...
	flag.StringVar(&c.DataDirectory, "data-dir", c.DataDirectory, "directory to store app data (defaults to ~/.metalicoin)")
	flag.StringVar(&c.DBPath, "db-path", c.DBPath, "path of database file (defaults to ~/.metalicoin/data.db)")
	...
	flag.StringVar(&c.WalletDirectory, "wallet-dir", c.WalletDirectory, "location of the wallet files. Defaults to ~/.metalicoin/wallet/")
...
var devConfig = Config{
	...
	PeerListURL:            "https://metalicoin.com/peers.txt",
	...
	LaunchBrowser: false,
	// Data directory holds app data -- defaults to ~/.metalicoin
	DataDirectory: filepath.Join(home, ".metalicoin"),
